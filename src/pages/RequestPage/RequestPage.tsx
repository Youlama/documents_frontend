    ...
    return (
        <Form onSubmit={sendRequest} className="pb-5">
            ...
            <Row className="mb-5 fs-5 w-25">
                <CustomTextarea label="Причина смены фамилии" placeholder="Введите причина смены фамилии" value={reason} setValue={setReason} disabled={!isDraft || is_superuser}/>
            </Row>
            <Row>
